    ...
    <>
      <header className="flex flex-col sm:flex-row items-center justify-between bg-white p-4 rounded-3xl lg:rounded-4xl shadow-sm border border-cream gap-4">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-chile text-white px-6 py-3 rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2"
        >
